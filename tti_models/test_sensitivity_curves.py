...
class PCRTestSensitivityCurve(TestSensitivityProfile):
    ...
    def __init__(self, pcr_pars_path, loss_prob = 0.0, test_specificity = 1., swab_error_rate = 0.):
        ...
        self.test_specificity = 1.0#test_specificity
    ...
    def test(self, people, inds):
        ...
        is_infectious            = cvu.itruei(people.exposed, inds) # only care about infectious individuals
        infectious_age_vec       = t - people.date_exposed[is_infectious]
        ...
        is_well = cvu.ifalsei(people.exposed, inds)
