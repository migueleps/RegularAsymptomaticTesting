...
sympt_testing = {f"{uptake:.2f}":test_prob_with_curve(test_profile_key = "pcr",
                                                symp_prob = uptake,
...
sim_pars = dict(use_waning = True,
                ...
                pop_size = 100000,
                n_days = 180,
                test_sensitivity_profiles = {"pcr": pcr_curve},
...
def run_msim(sim_label, contact_scenario, growth_rate):
    ...
    msim.mean()
    msim.save(f"sympt_testing/SYMPT_INVESTIGATION_{contact_scenario}_{growth_rate}_{sim_label}.msim")
